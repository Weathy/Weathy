...
public class DBManager extends SQLiteOpenHelper {
    ...
    public void addWeather(String cityName, int currentTemp, String condition, int temp_min, int temp_max, String sunrise, String sunset, String windSpeed, int humidity, int pressure, String feels_like, String visibility, String last_update, String dayLength) {
        ...
        values.put(context.getResources().getString(R.string.db_cityName), cityName);
        values.put(context.getResources().getString(R.string.db_current_temp), currentTemp);
        values.put(context.getResources().getString(R.string.db_condition), condition);
        values.put(context.getResources().getString(R.string.db_temp_min), temp_min);
        values.put(context.getResources().getString(R.string.db_temp_max), temp_max);
        values.put(context.getResources().getString(R.string.db_sunrise), sunrise);
        values.put(context.getResources().getString(R.string.db_sunset), sunset);
        values.put(context.getResources().getString(R.string.db_wind_speed), windSpeed);
        values.put(context.getResources().getString(R.string.db_humidity), humidity);
        values.put(context.getResources().getString(R.string.db_pressure), pressure);
        values.put(context.getResources().getString(R.string.db_feels_like), feels_like);
        values.put(context.getResources().getString(R.string.db_visibility), visibility);
        values.put(context.getResources().getString(R.string.db_last_update), last_update);
        values.put(context.getResources().getString(R.string.db_day_length), dayLength);
    ...
    public void addTwentyHourWeather(int currentTemp, int feels_like, String windSpeed, int humidity, String condition, int pressure, String time, String date) {
        ...
        values.put(context.getResources().getString(R.string.db_condition), condition);
        values.put(context.getResources().getString(R.string.db_pressure), pressure);
        values.put(context.getResources().getString(R.string.db_time), time);
        values.put(context.getResources().getString(R.string.db_date), date);
    ...
    public void addTenDayWeather(String date, int max_temp, int min_temp, String condition, Double windspeed, int humidity, String weekday, int yearday, int year) {
        ...
        database.beginTransaction();
        values.put(context.getResources().getString(R.string.db_date), date);
        values.put(context.getResources().getString(R.string.db_temp_max), max_temp);
        values.put(context.getResources().getString(R.string.db_temp_min), min_temp);
        values.put(context.getResources().getString(R.string.db_condition), condition);
        values.put(context.getResources().getString(R.string.db_wind_speed), windspeed);
        values.put(context.getResources().getString(R.string.db_humidity), humidity);
